...
--[[pixelshader@unalpha:
---$include "unalpha.hlsl"
]]
--[[pixelshader@replace_col:
---$include "replace_col.hlsl"
]]
--[[pixelshader@luma_as_alpha:
---$include "luma_as_alpha.hlsl"
]]
--[[pixelshader@mask_by_luma:
---$include "mask_by_luma.hlsl"
]]
...
-- renders properly only when the image is loaded propertly.
...
if extra_filter == 1 and load_success then
